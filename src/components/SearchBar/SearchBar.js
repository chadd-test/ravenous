import React from 'react'; import './SearchBar.css';
...
class SearchBar extends React.Component {
        ...
        handleSearch (event) {
            const search = this.props.searchYelp;
        ...
        render () {
            return (
              ...
              <div className="SearchBar-fields"> <input onChange={this.handleTermChange} placeholder="Search Businesses" />
